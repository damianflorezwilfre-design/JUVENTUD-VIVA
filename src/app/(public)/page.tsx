    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-24 bg-jv-dark relative z-10 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              { icon: <Users size={40} className="text-jv-turquoise" />, title: "Liderazgo Comunitario", desc: "Formamos jóvenes capaces de liderar iniciativas de impacto social." },
              { icon: <BookOpen size={40} className="text-jv-purple" />, title: "Educación Continua", desc: "Ofrecemos talleres y programas para el desarrollo personal y profesional." },
              { icon: <Heart size={40} className="text-red-400" />, title: "Acción Social", desc: "Participamos activamente en la mejora de nuestras comunidades." }
            ].map((feature, idx) => (
              <motion.div
                key={idx}
                variants={fadeIn}
